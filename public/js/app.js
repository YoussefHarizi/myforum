...
var render = function() {
  ...
  return _c("div", [
    _c("img", {
      staticClass: "fixed hidden lg:block inset-0 h-full",
      staticStyle: { "z-index": "-1" },
      attrs: { src: "images/wave.png" }
    }),
    _vm._v(" "),
    _c(
      "div",
      {
        staticClass:
          "w-screen h-screen flex flex-col justify-center items-center lg:grid lg:grid-cols-2"
      },
      [
        _c("img", {
          staticClass:
            "hidden lg:block w-1/2 hover:scale-150 transition-all duration-500 transform mx-auto",
          attrs: { src: "images/unlock.svg" }
        }),
        _vm._v(" "),
        _c(
          "form",
          {
            staticClass: "flex flex-col justify-center items-center w-2/3",
            on: {
          ...
          [
            _c("img", { staticClass: "w-32", attrs: { src: _vm.imgUser } }),
            _vm._v(" "),
            _c(
              "h2",
              {
                staticClass:
                  "my-8 font-display font-bold text-3xl text-gray-700 text-center"
              },
              [_vm._v("\n                Welcome to Youna Forum\n            ")]
            ),
            _vm._v(" "),
            _c("div", { staticClass: "relative w-full text-center" }, [
              _c("i", {
                staticClass: "fa fa-user absolute text-primarycolor text-xl"
              }),
              _vm._v(" "),
              _c("input", {
                directives: [
                ...
                staticClass:
                  "w-9/12 pl-8 border-b-2 font-display focus:outline-none focus:border-primarycolor transition-all duration-500  text-lg",
            ...
            _c(
              "div",
              { staticClass: "relative mt-8 w-full text-center" },
              [
                _c("i", {
                  staticClass: "fa fa-lock absolute text-primarycolor text-xl"
                }),
                _vm._v(" "),
                _c("input", {
                  directives: [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "relative mt-8 text-left w-9/12" }, [
              _c(
                "label",
                {
                  staticClass: "inline-flex items-center text-sm text-gray-700",
                  attrs: { for: "remember" }
                },
                [
                  _c("input", {
                    ...
                    staticClass: "form-checkbox text-primarycolor",
                    attrs: {
                      type: "checkbox",
                      name: "remember",
                      id: "remember"
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "flex items-baseline mt-8 justify-between md:w-9/12 sm:w-full"
      },
      [
        _c(
          "button",
          {
            staticClass:
              "inline-block py-3 px-12 bg-primarycolor rounded-full text-white text-lg transform hover:translate-y-1 transition-all duration-500",
            attrs: { type: "submit" }
          },
          [_vm._v("\n                    Login\n                ")]
        ),
        ...
        _c(
          ...
          {
            staticClass:
              "self-end text-gray-600 block py-3 hover:text-primarycolor",
            attrs: { href: "#" }
          },
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "text-left mt-8 sm:w-full md:w-9/12" }, [
      _c(
        "a",
        {
          staticClass:
            " inline-block border-none rounded-full bg-gray-700 px-6 py-3 text-white text-lg transform hover:translate-y-1 transition-all duration-500",
          attrs: { href: "/login/github" }
        },
        [_vm._v("Github "), _c("i", { staticClass: "fab fa-github" })]
      ),
      _vm._v(" "),
      _c(
        "a",
        {
          staticClass:
            " inline-block border-none rounded-full bg-blue-700 px-6 py-3 text-white text-lg transform hover:translate-y-1 transition-all duration-500",
  ...
  function() {
    ...
    return _c(
      "p",
      { staticClass: "pt-4 m-8 text-gray-600 w-9/12 text-center" },
      [
        _vm._v("\n                Don't have an account?\n                "),
        _c(
          "a",
          {
            staticClass: "text-primaryColor font-bold underline",
            attrs: { href: "/register" }
          },
          [_vm._v("register")]
        )
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); // vform
...
var app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: "#app",
  router: new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"](_routes_index__WEBPACK_IMPORTED_MODULE_2__["default"]),
...
__webpack_require__(/*! C:\laragon\www\myforum\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\myforum\resources\css\app.css */"./resources/css/app.css");
